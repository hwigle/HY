...
<body>
	<div id="myDIV" class="header">
		...
		<input type="text" id="myInput" onkeypress="enterkey"
			placeholder="Title..."> <span class="addBtn">Add</span>
	</div>
...
function makeli(todo){
	var li = $("<li>").attr("data-no",todo.no) // 소문자
